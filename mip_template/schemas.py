...
from mwcommons.ticdat_types import float_number, text, non_negative_float
...
input_schema = PanDatFactory(
    ...
    sample_input_table=[
        ["Primary Key One", "Primary Key Two"],
        ["Data Field One", "Data Field Two"],
    ],
)
# endregion
...
input_schema.add_parameter(
    "Sample Two Values Parameter",
    default_value=SampleConstants.FIRST_VALUE,
...
input_schema.add_parameter(
    "Sample Date Parameter", default_value="11/21/2022", datetime=True
)
# endregion
...
input_schema.set_data_type(
    table=table,
    field="Data Field One",
    **text(strings_allowed=("Option 1", "Option 2")),
)
